...
If you own a WCA[^1] account, you can also visit the [statistics.worldcubeassociation.org](https://statistics.worldcubeassociation.org/) website and either compute your own queries or use one of mine from this repository. 
